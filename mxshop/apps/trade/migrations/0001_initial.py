    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_no', models.CharField(max_length=100, null=True, unique=True, verbose_name='\u4ea4\u6613\u53f7')),
                ('pay_status', models.CharField(choices=[('success', '\u6210\u529f'), ('cancle', '\u53d6\u6d88'), ('cancle', '\u5f85\u652f\u4ed8')], max_length=10, verbose_name='\u8ba2\u5355\u72b6\u6001')),
                ('post_script', models.CharField(max_length=11, verbose_name='\u8ba2\u5355\u7559\u8a00')),
                ('order_mount', models.FloatField(default=0.0, verbose_name='\u8ba2\u5355\u7559\u8a00')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('good_nums', models.IntegerField(default=0, verbose_name='\u8d2d\u4e70\u6570\u91cf')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
