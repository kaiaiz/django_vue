...
class ShoppingCart(models.Model):
    ...
    def __str__(self):
        return "%s(%d)".format(self.goods.name, self.good_nums)
...
class OrderInfo(models.Model):
    ...
    order_sn = models.CharField(
        max_length=30, unique=True, verbose_name=u"订单号")
    trade_no = models.CharField(
        max_length=100, unique=True, null=True, verbose_name=u"交易号")
    ...
    address = models.CharField(
        max_length=100, default="", verbose_name=u"收货地址")
    singer_name = models.CharField(
        max_length=20, default="", verbose_name=u"签收人")
